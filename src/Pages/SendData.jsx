       ...
       >
          <label className="text-sm text-richblack-5" htmlFor='name'>Name<sup className='text-red-500'>*</sup></label>
           <input
            ...
            <label className="text-sm text-richblack-5" htmlFor='name'>Social Media Handle<sup className='text-red-500'>*</sup></label>
             <input
                ...
                {/* Upload Images  */}
                <label className="text-sm text-richblack-5" htmlFor=''>
